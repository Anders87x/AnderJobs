...
<!--=================================
Banner -->
<section class="banner bg-holder bg-overlay-black-30 text-white" style="background-image: url(public/images/bg/banner-01.jpg);">
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="text-white mb-3">Deje <span class="text-primary"> su CV & Obtenga </span> su trabajo deseado</h1>
        <p class="lead mb-4 mb-lg-5 font-weight-normal">Encuentre trabajos, empleo y oportunidades profesionales</p>
            ...
            <form class="form row">
              <div class="col-lg-5">
                <div class="form-group">
                  <div class="d-flex">
                    <label>Que?</label>
                    <span class="ml-auto">e.g. Trabajo, Empresa, Titulo</span>
                  </div>
                  <div class="position-relative left-icon">
                    <input type="text" class="form-control" name="job_title" placeholder="Titulo Trabajo, Habilidad o Empresa">
              ...
              <div class="col-lg-5">
                <div class="form-group">
                  <div class="d-flex">
                    <label>Donde?</label>
                    <span class="ml-auto">e.g. Ciudad, Distrito</span>
                  </div>
                  <div class="position-relative left-icon">
                    <input type="text" class="form-control location-input" name="job_title" placeholder="Cuidad o Distrito">
        ...
        <div class="job-tag mt-4">
          <ul class="justify-content-center">
            <li class="text-primary">Palabras clave de tendencia:</li>
    ...
    <div class="row align-items-center">
      <div class="col-lg-3 mb-4 mb-lg-0">
        <div class="section-title">
          <h2 class="title">Elije tu sector</h2>
          <p class="mb-0">Por favor selecciona tu sector de trabajo</p>
        </div>
        <a class="btn btn-outline btn-lg" href="#">Ver mas Trabajos</a>
      </div>
...
<section class="space-ptb">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <div class="section-title">
          <h2 class="title">Trabajos En Los Que Podrías Estar Interesado</h2>
        </div>
      </div>
      <div class="col-12">
        <div class="browse-job d-flex border-0 pb-3">
          <div class="mb-4 mb-md-0">
            <ul class="nav nav-tabs justify-content-center d-flex" id="myTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Trabajos Populares</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Trabajos Recientes</a>
              </li>
            </ul>
          </div>
          <div class="job-found ml-auto mb-0">
            <span class="badge badge-lg badge-primary">24123</span>
            <h6 class="ml-3 mb-0">Trabajos Encontrados</h6>
          </div>
        </div>
          ...
          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="row mt-3">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="public\images\svg\09.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class=" job-list-logo">
                    <img class="img-fluid" src="public\images\svg\06.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
          ...
          <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
            <div class="row mt-4">
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="public\images\svg\11.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="public\images\svg\12.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class=" job-list-logo">
                    <img class="img-fluid" src="public\images\svg\13.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="public\images\svg\14.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6 mb-4 mb-sm-0">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="public\images\svg\15.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
              ...
              <div class="col-lg-6">
                ...
                <div class="job-list">
                  <div class="job-list-logo">
                    <img class="img-fluid" src="public\images\svg\16.svg" alt="">
                  </div>
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8 col-md-10">
        <div class="section-title center">
          <h2 class="title">Manera Más Fácil De Usar</h2>
          <p>Date el poder de la responsabilidad. Recuerda que lo único que te detiene eres tú mismo.</p>
        </div>
      </div>
    </div>
    <div class="row bg-holder-pattern mt-3 mt-md-4 mr-md-0 ml-md-0" style="background-image: url('public/images/step/pattern-01.png');">
      <div class="col-md-4 mb-4 mb-md-0">
        <div class="feature-step text-center">
          ...
          <div class="feature-info-content pb-2 pb-md-0">
            ...
            <p class="mb-0">Cree una cuenta y acceda a sus configuraciones guardadas en cualquier dispositivo.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-4 mb-md-0">
        <div class="feature-step text-center">
          ...
          <div class="feature-info-content pb-2 pb-md-0">
            <h5>Encuentra tu vacante</h5>
            <p class="mb-0">No se limite a buscar. Ser encontrado. Pon tu CV delante de grandes empleadores.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4 mb-0">
        <div class="feature-step text-center">
          ...
          <div class="feature-info-content pb-2 pb-md-0">
            <h5>Consigue un trabajo</h5>
            <p class="mb-0">Su próximo paso profesional comienza aquí. Elija trabajo entre miles de empresas.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-6 mb-lg-0 mb-4">
        <div class="feature-info feature-info-02 p-4 p-md-5 bg-primary">
          ...
          <div class="feature-info-content pl-sm-4 pl-0">
            ...
            <p class="text-white">Su próximo rol podría ser en una de estas organizaciones líderes.</p>
            <a href="#">Buscar Ahora<i class="fas fa-long-arrow-alt-right"></i> </a>
          </div>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="feature-info feature-info-02 p-4 p-md-5 bg-dark">
          ...
          <div class="feature-info-content pl-sm-4 pl-0">
            ...
            <p class="text-white">Cinco millones de CV que se pueden buscar en un solo lugar con nuestra base de datos de CV vinculada.</p>
            <a href="#">Anunciar un trabajo<i class="fas fa-long-arrow-alt-right"></i> </a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-7 mb-4 mb-sm-5 mb-lg-0">
        <div class="d-sm-flex">
          <div class="align-self-center footer-top-logo"><img class="img-fluid" src="public\images\logo-dark.svg" alt=""></div>
          <div class="pl-sm-3 ml-sm-3 mt-3 mt-sm-0 border-sm-left ">¡Cree una cuenta gratuita para encontrar miles de empleos, oportunidades laborales y profesionales a su alrededor!</div>
        </div>
      </div>
      <div class="col-lg-5">
        <div class="row">
          <div class="col-sm-6">
            <div class="counter mb-4 mb-sm-0">
              ...
              <div class="counter-content">
                ...
                <label class="mb-0">Empleos Publicados</label>
              </div>
            </div>
          </div>
          <div class="col-sm-6">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header p-4">
        <h4 class="mb-0 text-center">Iniciar Sesion</h4>
                ...
                <a class="nav-link active" data-toggle="tab" href="#candidate" role="tab" aria-selected="false">
                  <div class="d-flex">
                    ...
                    <div class="ml-3">
                      ...
                      <p class="mb-0">Iniciar Sesion como Postulante</p>
                    </div>
                  </div>
                </a>
              </li>
                ...
                <a class="nav-link" data-toggle="tab" href="#employer" role="tab" aria-selected="false">
                  <div class="d-flex">
                    ...
                    <div class="ml-3">
                      ...
                      <p class="mb-0">iniciar Sesion como Empleador</p>
                    </div>
                  </div>
                </a>
              </li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="candidate" role="tabpanel">
              <form class="mt-4">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <a class="btn btn-primary btn-block" href="#">Iniciar Sesion</a>
                  </div>
                  <div class="col-md-6">
                    <div class="ml-md-3 mt-3 mt-md-0 forgot-pass">
                      <a href="#">Olvidaste tu contraseña?</a>
                      <p class="mt-1">No tienes una cuenta? <a href="register.html">Registrate Aqui</a></p>
                    </div>
                  </div>
                </div>
              </form>
...
Javascript -->
    ...
    <script src="public\js\counter\jquery.countTo.js"></script>
    <script src="public\js\owl-carousel\owl-carousel.min.js"></script>
    <script src="public\js\magnific-popup\jquery.magnific-popup.min.js"></script>
